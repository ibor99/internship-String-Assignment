...
string wordToCount = "encapsulation";
...
Console.WriteLine($"Amount of times the word encapsulation appears : {count}");
...
string inverseText = ReverseString( text );
...
string wToReplace = "object-oriented programming";
string newWord = "OOP";

string replacedText = text.Replace(wToReplace, newWord);
